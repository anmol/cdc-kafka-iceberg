...
update employee_3 set created_at = now() - interval '1 DAY' where name = 'tom+3';

update employee_3 set name='tom+5' where id=5;
update employee_3 set name='tom+6' where id=5;
update employee_3 set name='tom+7' where id=5;
update employee_3 set name='tom+8' where id=5;
update employee_3 set name='tom+4' where id=5;

select * from employee_3;


create table employee_no_pk
(
id bigint GENERATED BY DEFAULT AS IDENTITY,
name character varying,
...
insert into employee_no_pk(name) values('jason');
insert into employee_no_pk(name) values('jason+1');

create table employee_no_pk_2
(
id bigint GENERATED BY DEFAULT AS IDENTITY,
name character varying
);

insert into employee_no_pk_2(name) values('cris');
insert into employee_no_pk_2(name) values('cris+1');
insert into employee_no_pk_2(name) values('cris+2');
insert into employee_no_pk_2(name) values('cris+3');

select * from employee_no_pk_2;
